...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/addproduct.css" media="screen" type="text/css" />
        ...
        <header>
            <div class="head-main">
                ...
                <div class="right-section">
                    ...
                    <span><a href="AdminHome.jsp">Home</a></span>
                ...
                <div class="row justify-content-center mt-0">
                    <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-2 mb-2">
                        ...
                        <div class="card px-0 pt-2 pb-0 mt-3 mb-3">
                            <%-- <h3><strong>Delete Product</strong></h3>--%><h2 style="margin-top: 20px; margin-bottom: 30px;"> <span class="badge bg-warning text-dark">Delete Product</span></h2>
                              <div class="row">
                                <div class="col-md-12 mx-0">
                                    <form id="msform" action="DeleteProduct" method="post" >
                                        <fieldset>
                                            <div class="form-card p-4">
                                                <h2 class="fs-title pb-2">Delete Product Details</h2> 
                                                <div class="row">
                                                   
                                                    <div class="col-12"><input type="number" id="name" name="id" placeholder="Enter ID" required=""/> </div>
                                                </div>
