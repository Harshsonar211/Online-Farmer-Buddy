...
<html>
    ...
    <body>
         <form method="POST" action="adminupdateprofile.jsp">  
              <div class="header" style='display: flex;'>
                   <div class="left-section" style='width: 30%; padding-left: 10px;'>
                       <h1 style="color: white; font-size: 30px;">FARMER'S BUDDY</h1>
                </div>
                  <div class="Cart" style="width: 70%;">
               <a href="adminlogout.jsp"><li class="fa fa-lock"></li><b>LogOut</b></a>
               <a href="AdminHome.jsp"><li class="fa fa-home"></li><b>Home</b></a>
              </div>
              </div> 
        <div class="main">
		...
		<div class="second">
                    ...
                    <center><h1>Profile</h1> 
                        <h1> Welcome,"<%out.println(rs.getString(5));%>"</h1>
                        </center>
				<div class="show">
				...
				<input type="text" class="data" id="field2" name="add" disabled value="<%out.println(rs.getString(2));%>" >
				</div>
				
				<div class="show">
				<label><b>Contact No.:</b></label><br>
				<input type="text" class="data" id="field3" name="mob" disabled value="<%out.println(rs.getString(4));%>" >
				</div>
				
				<div class="show">
				<label><b>Email-id:</b></label><br>
				<input type="text" class="data" id="field4" name="email" disabled value="<%out.println(rs.getString(3));%>"><br>
				</div>
				<div class="btn-edit">
				<center><a href="adminupdateprofile.jsp"><button class="btn" onclick="letDisable()" id="field5" value="Edit">Edit Profile                                    
                                    </button></a>
                                      </center>  
