(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "farmarbuddy-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "farmerbuddy01@gmail.com"; // Your Business PayPal's account email address
		 this.paypalURL = "https://www.paypal.com/payment"; // The URL of the PayPal's form "; // The URL of the PayPal's form 
