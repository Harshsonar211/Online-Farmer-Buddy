    ...
    <body>
         <form method="POST" action="adminupdateprofile.jsp">  
              <div class="header" style='display: flex;'>
                   <div class="left-section" style='width: 30%; padding-left: 10px;'>
                       <h1 style="color: white;">FARMER'S BUDDY</h1>
                </div>
		...
		<div class="second">
                    ...
                    <center><h1>Profile</h1> 
                        <h1>Welcome,<%out.println(rs.getString(5));%></center>
                     </form>
				<div class="show">
                                   ...
                                   try
                                      {
                                         if(user!=null)
                                         {
                                         st.executeUpdate("update admin set name='"+user+"',address='"+add+"',email='"+email+"', mobile='"+mob+"'where uid='"+uid+"'");      
