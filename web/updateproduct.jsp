<%-- 
    ...
    Created on : 23 Apr, 2021, 10:45:53 PM
    Author     : HP
--%>
                            ...
                            <h3><strong>Update Product Details</strong></h3>
                              <div class="row">
                                <div class="col-md-12 mx-0">
                                    <form id="msform" action="UpdateProduct1" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            <div class="form-card p-4">
                                                <h2 class="fs-title pb-2">Update Details</h2> 
                                                <div class="row">
